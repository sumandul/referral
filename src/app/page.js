...
import { HiXMark, HiOutlineChevronLeft, HiOutlineChevronRight, HiArrowSmallLeft } from "react-icons/hi2";
...
export default function Home() {
  ...
  return (
    <>
            ...
            <div>
              ...
              <div className="  bg-white shadow">
                ...
                <div className="px-6  text-[#9797a5]">
                  ...
                  <div className=" ">
                    <p className=" mb-5 ">Here are a few things you can do:</p>
                  ...
                  <div className=" mt-5 text-[#9797a5] pb-6 ">
      ...
      <div className="">
        <div className="px-4 sm:flex sm:justify-center mt-6 sm:mt-20">

          <div className=" ">
            <div className="bg-[#2B324D]   rounded-[10px]  text-white py-4 px-4    flex items-center sm:hidden  "> <HiArrowSmallLeft className="text-[26px] mr-20" />Referral Program</div>
            <div className=" bg-white mt-4 sm:mt-0  py-10 px-4 sm:px-8 shadow rounded">
              <h2 className=" text-[18px]  hidden sm:block  text-[#0f0f39] font-semibold">Referral Program</h2>
              <div className=" sm:m-5 rounded-lg bg-gray-100 p-4 sm:p-8 dark:bg-gray-900">
                <div className="flex">
                  <div>
                    <svg
                      width="24"
                  ...
                  <div>
                    <p class="  text-[14px] sm:text-[18px] text-[#0f0f39] font-bold">
                      {" "}
              ...
              <div className=" block sm:hidden mt-8">
                <div>
                  ...
                  <label className=" font-bold text-[14px]  text-[#2B324D]">
                    Share your unique link
                  </label>
                  <hr className="  my-5" />
                  <div className="  my-10 flex  border-[0.9px] rounded-full justify-between pl-3 font-semibold     h-10 "> <input placeholder="For appointments canceled " className="    text-[12px] text-[#838187] rounded-full" /> <button className="  py-1  px-4  bg-[#2B324D] text-white rounded-full  text-[12px]">Copy Link</button></div>
                </div>
                <div className=" mt-10">
                  <label className=" font-bold text-[14px]  text-[#2B324D]">
                  ...
                  <hr className=" my-5" />
                  <input placeholder="Enter email address " className=" rounded-full mt-4   border-[0.9px] px-3  text-[12px] text-[#838187]  font-semibold  w-full  h-10" />
                </div>
                <div className=" mt-4">
                  <input placeholder="Enter name (optional)" className=" rounded-full   border-[0.9px] px-3  text-[12px] text-[#838187]  font-semibold  w-full  h-10" />
                </div>
                <div class="flex  mt-7 items-center justify-between text-[14px]  font-semibold ">
                  <div class="space-x-4">
                    <button
                      type="button"
                      class="  bg-[#2B324D] text-white  rounded-full px-4 py-2 whitespace-nowrap"
                    >
                      {" "}
                      Send email
                    </button>
                    <button
                      type="button"
                      class="text-[#2B324D] text-[14px] font-normal focus:outline-none"
            ...
            <div className=" mt-20  py-7 px-3 sm:px-10   bg-white shadow rounded">
              ...
              <div className="overflow-y-auto">
                <table class="  w-full mt-3  ">
                  ...
                  <tbody className=" text-[14px] text-[#0f0f39] font-normal">
                    <tr className=" border-b-[1px]  border-[#D7DAEC]">
                      <td className=" py-8">suman </td>
                      <td>suman853@gmail.com</td>
